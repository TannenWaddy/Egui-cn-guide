...
本指南已更新至 egui 官方仓库的以下提交：

- **最新提交**：`b9a0723d88dee87ba0965470b554a6efdab1d0bb` (2026-08-18)
- **版本**：egui 0.36.1
- **主要更新内容**：
  - 新增 `extra_text_line_spacing` 属性，用于控制文本行之间的额外垂直间距
  - 新增 `Window::title_frame` 方法，用于自定义窗口标题栏的边框
  - 新增面板拖拽打开功能，完全折叠的面板可以通过拖拽重新打开
  - 新增窗口主题同步功能，自动将原生窗口主题与 egui 主题保持一致
  - 修复 DragValue 在获得焦点时的行为，不再回滚外部修改的值
  - 修复 TextEdit 提示文本不跟随对齐方式的问题
  - 修复面板分隔线位置和空间预留问题
